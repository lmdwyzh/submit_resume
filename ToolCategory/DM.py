...
class DM:
    ...
    def FindPic(self, x1, y1, x2, y2, pic_name, delta_color, sim, method=5, drag=None):
        """
        :param x1:被匹配的图像区域的左上X坐标
        :param y1:被匹配的图像区域的左上Y坐标
        :param x2:被匹配的图像区域的右下X坐标
        :param y2:被匹配的图像区域的右下Y坐标
...
if __name__ == '__main__':
    ...
    # 找图
    # dm = DM(r"C:\Users\lmdwy\Desktop\Folder\img\Script\te\5.png")#截图
    # dm.SetPath(r"C:\Users\lmdwy\Desktop\Folder\img\Script")#模板路径
    # print(dm.FindPic(0, 0, 0, 0, "direction.png", ((0, 0, 221), (180, 30, 255)), 0.4, 5, False))
    ...
    # 测试OcrNum
    # dm = DM(r"C:\Users\lmdwy\Desktop\Folder\img\Script\direction.png")
    # dm.SetPath(r"C:\Users\lmdwy\Desktop\Folder\img\Script")
    # num = dm.OcrNum(0,0,0,0,"",0.9,"token_num")
    # print(num)

    # 截图窗口
    # dm = DM()
    # dm.BindWindow("","windows","windows","windows",0)
    ...
    dm.Capture(16, 116, 31, 131, r"./sub.png")
